...
export const Admin = `
    ...
    DO $$
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'admins_role') THEN
            CREATE TYPE admins_role AS ENUM ('SuperAdmin', 'Admin', 'Moderator', 'Author', 'Accountant');
        END IF;
    END$$;
